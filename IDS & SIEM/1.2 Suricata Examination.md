...
## Outcome
* Gained pratical experience using Suricata to trigger alerts on network traffic.
* Ability to create custom rules and run them in Suricata,
* Ability to monitor traffic captured in a packet capture file, and
* Ability to examine the fast.log and eve.json output.
